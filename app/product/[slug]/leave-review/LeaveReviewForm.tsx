...
import { IReviewFields } from '../product-review/review-fields.interface'
...
const LeaveReviewForm: FC<{ productId: number }> = ({ productId }) => {
	...
	if (isSuccess)
		return <div className=''>✅ Review successfully published!</div>
				...
				{isLoading ? (
					...
					<div>
						...
						{Object.entries(errors) && (
							<ul className='text-red animate-opacity text-sm lest-disc pl-4 mt-3'>
